...
export const translations = {
  en: {
    ...
    workspace: {
      ...
      step2Subtitle: "Document review workspace",
      situationTitle: "Your situation",
      contextLabel: "Situation context",
      inputLabel: "Upload or paste document",
      expand: "Expand",
      ...
      editable: "Editable",
      placeholder: "Paste an I-20 note, USCIS notice, school email, employer instruction, DS-160 reminder, or other visa-related text here.",
      btnAnalyze: "Create Summary & Tasks",
      btnAnalyzing: "Analyzing...",
      btnHelper: "Upload or paste a document, then turn the important points into tasks, dates, and questions to ask.",
      analyzing: "Analyzing...",
      analyzingDesc: "Analyzing your document... This may take a few seconds.",
      tabExplain: "Summary",
      tabChecklist: "To-do list",
      tabSafety: "Questions & resources",
